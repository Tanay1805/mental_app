  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.meter}>
        ...
        <View style={{borderWidth:4,height:'60%', width: '40%',borderRadius:'100%',marginLeft:'31%',marginTop:30, borderColor:'#4949C9'}}></View>
      </View>
      <View style={{borderWidth:1, marginTop: 18,}}></View>
      <View style={styles.container}>
        <View style={[styles.box1, styles.box]}>
          <View style={styles.innerBox1}>
            <Text style={styles.boxHeadings}>Steps</Text>
